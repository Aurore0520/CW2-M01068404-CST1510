...
def insert_datasets_metadata(dataset_name, source, category, last_updated, record_count=None, file_size_mb=None):
...
def update_datasets_metadata(conn, id, name=None, last_updated=None, source=None):
    ...
    try:
        ...
        if source is not None:    
            cursor.execute("UPDATE datasets_metadata SET souce=? WHERE id=?", (source, id))
